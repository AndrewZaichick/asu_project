...
# Основная модель теста, связанного с лекцией или лабораторной работой
class Test(models.Model):
    ...
    # Связь с лабораторной работой (опционально)
    ...
    # Ссылки для маршрутов (используются в шаблонах)
...
class AnswerOption(models.Model):
    ...
    weight = models.IntegerField(
        verbose_name='Вес ответа (Целое число, для неправильных ответов '
                     ...
                     'соблюдайте баланс — сумма весов правильных и '
    ...
    class Meta:
        ...
        unique_together = ('answer', 'question')  # Запрещаем одинаковые тексты ответов для одного вопроса


# Результат прохождения теста конкретным студентом
...
# Результаты ответов на каждый вопрос в тесте
